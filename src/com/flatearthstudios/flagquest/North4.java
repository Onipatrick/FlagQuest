...
public class North4 extends Activity {

	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.northamerica4);
    		...
    		imgBtnNorth.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				...
    				mpIncorrect.start();
    				Toast.makeText(North4.this, "Incorrect, please try again.", Toast.LENGTH_SHORT).show();
    			}
    		...
    		imgBtnSouth.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				mpCorrect.start();    				
    				startActivity(new Intent(North4.this, North5.class));
    			}

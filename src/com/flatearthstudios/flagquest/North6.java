...
public class North6 extends Activity {

	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.northamerica6);
    		...
    		imgBtnNorth.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				...
    				mpIncorrect.start();
    				Toast.makeText(North6.this, "Incorrect, please try again.", Toast.LENGTH_SHORT).show();
    			}
    		...
    		imgBtnSouth.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				mpCorrect.start();    				
    				startActivity(new Intent(North6.this, North7.class));
    			}

...
public class South5 extends Activity {

	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.southamerica5);
    		...
    		imgBtnFlag1.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				...
    				mpIncorrect.start();
    				Toast.makeText(South5.this, "Incorrect, please try again.", Toast.LENGTH_SHORT).show();
    			}
    		...
    		imgBtnFlag2.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				mpCorrect.start();    				
    				startActivity(new Intent(South5.this, South6.class));
    			}

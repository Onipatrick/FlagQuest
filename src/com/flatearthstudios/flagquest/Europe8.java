...
public class Europe8 extends Activity {

	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.europe8);
      ...
      //Accesses Text View by the ID    
		...
		imgBtnNorth.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mpIncorrect.start();
				Toast.makeText(Europe8.this, "Incorrect, please try again.", Toast.LENGTH_SHORT).show();
			}
		...
		imgBtnSouth.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				mpCorrect.start();    				
				startActivity(new Intent(Europe8.this, Europe9.class));
			}

...
public class North5 extends Activity {

	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.northamerica5);
    		...
    		imgBtnNorth.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				...
    				mpIncorrect.start();
    				Toast.makeText(North5.this, "Incorrect, please try again.", Toast.LENGTH_SHORT).show();
    			}
    		...
    		imgBtnSouth.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				mpCorrect.start();    				
    				startActivity(new Intent(North5.this, North6.class));
    			}
